...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const projects = [{
        ...
        Description: "Динамічна specialty кав'ярня сучасного міста. Кавовий place, місце невинних ранків, мотивуючих зустрічей та натуральних вин. Для власників бізнесу, носіїв ідей, офісних інтровертів, дипломатів та бізнес партнерів. Для людей, яких об’єднує драйв та ритм сучасного міста. У меню – класика, фільтр, а на полицях кава від топових обсмажчиків України.",
