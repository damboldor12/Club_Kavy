...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const projects = [{
        ...
        Description: 'Міське кафе зі смачним продуктом та приємною атмосферою.',
        ...
        Description: "Динамічна specialty кав‘ярня сучасного міста. Кавовий place, місце невинних ранків, мотивуючих зустрічей та натуральних вин.",
    ...
    },
    {
        ...
        Description: 'Simple — сервіс створений, щоб вирішити будь-яку проблему кавового бізнесу',
        ...
        Description: "ROOF – кавовий проект, який об’єднує людей захоплених любов'ю до кави в одне велике ком'юніті.",
